...
//    private static final String CLASS = "com.lt.adv.b.b";
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) throws Throwable {
        ...
        XposedHelpers.findAndHookMethod(CLASS, lpparam.classLoader, "loadSplashAD", new XC_MethodReplacement() {
            @Override
            protected Object replaceHookedMethod(MethodHookParam param) throws Throwable {
                // 找到字段
                Object obj = XposedHelpers.getObjectField(param.thisObject, "latform");
                // 点击关闭
                XposedHelpers.callMethod(obj, "onAdCloseView");
